...
import java.io.File;
    ...
    public class FileSearch {
        ...
        public FileSearch(final String filename, final File baseDir, final int concurrency) {
        ...
        public static void main(final String[] args) {
            final String filename = "EuroPratik";
            final File baseDir = new File("/");
            final FileSearch ff = new FileSearch(filename, baseDir, 6);
