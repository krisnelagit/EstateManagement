...
//            message.setContent(multipart);
    ...
    public String sendCustomerPasswordMail(String subject, String messages, String stEmailId, String yourname) throws MessagingException, UnsupportedEncodingException {
        ...
        try {
            ...
            MimeMessage message = new MimeMessage(session);
            message.setFrom(new InternetAddress(from, "Karworx Admin"));
