...
<html>
    ...
    <center>
        <form action="insertSignUpBroker" method="POST">
        <table border="0" cellpadding="3" cellspacing="3" class="box04">
            ...
            <tbody>
                ...
                <tr>
                    <td align="left"> </td>
                    <td align="left"><input type="submit" name="checkbtn" value="Save" class="newbtn"/> <input type="reset" value="Clear All" class="newbtn"/> <a href="addsignupLink" class="newbtn">Cancel</a></td>
                </tr>
            </tbody>
        </table>
    </form>
