...
<%-- 
    Document   : ViewSignupProjectDetailsGrid
        ...
        <table class="display tablestyle" id="table_id">
            <thead>
                <tr>
                    ...
                    <th align="left">Wing / Flat No.</th>
                    <th align="left">Executive</th>
                    <th align="left">Balance / Total</th>
                    <th align="left" style="width: 64px">Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                <c:forEach var="ob" items="${signupdt}">
                    <tr>
                        ...
                        <td>${ob.wingnum} / ${ob.flatnum}</td>
                        <td>${ob.salespersonname}</td>
