...
<%-- 
    Document   : ViewNewSignupExecutiveGrid
    Created on : 12 Jan, 2016, 2:05:20 PM
    Author     : pc2
--%>
...
<html>
    <head>
        ...
        <title>View Sign up's Bookings</title>
    ...
    <body>              
        <a href="viewnewsignupGridLink" class="create_link" style="float: right"><img src="images/school50.png"/></a>
