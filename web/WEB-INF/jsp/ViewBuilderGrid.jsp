...
<%-- 
    Document   : ViewBuilderGrid
    Created on : 9 Dec, 2015, 9:14:05 AM
    Author     : pc2
--%>
...
<html>
    ...
    <body>
        ...
        <strong class="heading"><img src="image/builder.png" align="absmiddle" /> Builder Master</strong>
        <hr class=" hr"/>
        <form action="multipleDeleteUser" id="myform" method="POST">
